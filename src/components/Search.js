...
//   // method to run filterPlants function pased from previous component on any input change
//   handleSearch = event => {
//     const { value } = event.target; // 2. value indicates the current input from target
//     this.props.filterPlants(value); // 3. run filter function (passed from props) with current value
